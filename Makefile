.PHONY: all-up all-down all-build logs help all-rebuild services-up services-stop app-up app-down app-build app-rebuild
...
services-stop: ## Stop and remove backend services
